...
juegos.forEach(function(juego) {
    juego.imprimirEnPantalla = function() {
...
function ordenarJuegosPorPrecio(juegosAOrdenar, orden = 'ASC') {
    return juegosAOrdenar.slice().sort((a, b) => {
        return orden === 'DESC' ? b.precio - a.precio : a.precio - b.precio;
    });
};
